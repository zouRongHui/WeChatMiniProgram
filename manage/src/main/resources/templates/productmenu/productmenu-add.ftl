        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline layui-upload">
                    <input type="hidden" name="menuIcon" required="" lay-verify="menuIcon" autocomplete="off" class="layui-input">
                    <div class="layui-upload-list" style="margin-top: 0px;" id="menuIcon-show">
                        <a href="javascript:void(0)"><img class="layui-upload-img" id="menuIcon" src="${path}/images/upload.png"  style="width: 136px;height: 136px;"></a>
                    </div>
                </div>
                <div class="layui-form-mid layui-word-aux">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline layui-upload">
                    <input type="hidden" name="advertPhoto" required="" lay-verify="advertPhoto" autocomplete="off" class="layui-input">
                    <div class="layui-upload-list" style="margin-top: 0px;" id="advertPhoto-show">
                        <a href="javascript:void(0)"><img class="layui-upload-img" id="advertPhoto" src="${path}/images/upload.png"  style="width: 175.5px;height: 106px;"></a>
                    </div>
                </div>
                <div class="layui-form-mid layui-word-aux">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="needLogin" lay-verify="">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="hidden" name="supportUserType" value="" lay-verify="">
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                    <textarea placeholder="请输入内容" id="productDesc" name="productDesc" lay-verify=""
                              style="display:block;" class="layui-textarea"></textarea>
                </div>
            </div>
            <div class="layui-form-item">
