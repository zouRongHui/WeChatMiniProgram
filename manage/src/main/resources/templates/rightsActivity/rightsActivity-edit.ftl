        ...
        <form class="layui-form" lay-filter="form_edit">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="title" name="title" lay-verify="title" autocomplete="off" class="layui-input" maxlength="10" placeholder="最大10个汉字" value="${data.title!''}">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label"><span class="x-red">*</span>副标题</label>
                <div class="layui-input-block">
                    <input type="text" id="subtitle" name="subtitle" lay-verify="subtitle" autocomplete="off" class="layui-input" maxlength="20" placeholder="最大20个汉字" value="${data.subtitle!''}">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline layui-upload">
                    <div class="layui-upload-list" style="margin-top: 0px;">
                        <input type="hidden" id="imageBackground_url" name="imageBackground" lay-verify="imageBackground" value="${data.imageBackground!''}">
                        <a href="javascript:void(0)"><img class="layui-upload-img" id="imageBackground" src="${data.imageBackground!''}"  style="width: 125px;height: 241.3px;object-fit: cover;"></a>
                    </div>
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline layui-upload">
                    <div class="layui-upload-list" style="margin-top: 0px;">
                        <input type="hidden" id="imageLogo_url" name="imageLogo" lay-verify="imageLogo" value="${data.imageLogo!''}">
                        <a href="javascript:void(0)"><img class="layui-upload-img" id="imageLogo" src="${data.imageLogo!''}"  style="width: 128px;height: 128px;object-fit: cover;"></a>
                    </div>
                </div>
                <div class="layui-form-mid layui-word-aux">
                    <i class="layui-icon layui-icon-tips" style="color: red"></i>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea placeholder="请输入内容" id="introduce" name="introduce" lay-verify="introduce" style="display:block;" class="layui-textarea"> ${data.introduce!''}</textarea>
                </div>
            </div>
            <#--页面展示元素的配置 结束-->
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="startDate" name="startDate" lay-verify="startDate" autocomplete="off" class="layui-input wd-laydate" readonly value="${data.startDate!''}">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">活动截止日期</label>
                <div class="layui-input-inline">
                    <input type="text" id="endDate" name="endDate" lay-verify="endDate" autocomplete="off" class="layui-input wd-laydate" readonly value="${data.endDate!''}">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">领取开始时间</label>
                <div class="layui-input-inline">
                    <input type="text" id="startTime" name="startTime" lay-verify="startTime" autocomplete="off" class="layui-input wd-laytime" readonly value="${data.startTime!''}">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">领取截止时间</label>
                <div class="layui-input-inline">
                    <input type="text" id="endTime" name="endTime" lay-verify="endTime" autocomplete="off" class="layui-input wd-laytime" readonly value="${data.endTime!''}">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">领取周期</label>
                <div class="layui-input-block">
                    <input type="hidden" name="receiveCycle" lay-verify="" value="${data.receiveCycle!''}">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="number" id="receiveTimesTotal" name="receiveTimesTotal" lay-verify="receiveTimesTotal" autocomplete="off" class="layui-input" value="<#if data.receiveTimesTotal??>${data.receiveTimesTotal?c}</#if>">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="number" id="phaseRightsTotalNum" name="phaseRightsTotalNum" lay-verify="phaseRightsTotalNum" autocomplete="off" class="layui-input" value="<#if data.phaseRightsTotalNum??>${data.phaseRightsTotalNum?c}</#if>">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="number" id="receiveTimesSingle" name="receiveTimesSingle" lay-verify="receiveTimesSingle" autocomplete="off" class="layui-input" value="<#if data.receiveTimesSingle??>${data.receiveTimesSingle?c}</#if>">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" id="rightsId" name="rightsId" lay-verify="rightsId" autocomplete="off" class="layui-input" value="${data.rightsId!''}">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="rightsStartDate" name="rightsStartDate" lay-verify="rightsStartDate" autocomplete="off" class="layui-input wd-laydate" readonly value="${data.rightsStartDate!''}">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="rightsEndDate" name="rightsEndDate" lay-verify="rightsEndDate" autocomplete="off" class="layui-input wd-laydate" readonly value="${data.rightsEndDate!''}">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="number" id="rightsNum" name="rightsNum" lay-verify="rightsNum" autocomplete="off" class="layui-input" value="${data.rightsNum!''}">
                </div>
            </div>
            <#--商城的权益信息配置 结束-->
            <div class="layui-form-item">
...
<script>
    $(function () {
        var phaseRightsNumCycle = "${data.phaseRightsNumCycle!''}";
        $("#sel_phaseRightsNumCycle").val(phaseRightsNumCycle);

        var receiveTimesSingleFrequency = "${data.receiveTimesSingleFrequency!''}";
        $("#sel_receiveTimesSingleFrequency").val(receiveTimesSingleFrequency);

        var hasAllowList = "${data.hasAllowList!''}";
        $("#sel_hasAllowList").val(hasAllowList);

        var receiveCycles = "${(data.receiveCycle)!''}";
        $(".receiveCycle").each(function () {
            if (receiveCycles.indexOf($(this).val()) > -1) {
